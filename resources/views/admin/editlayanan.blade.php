        ...
        <div class="col d-flex justify-content-center">
          <div class="card mt-4" style="width: 800px">
            <div class="card-body">
              ...
              <form action="/postEditlayanan/{{ $layanankendaraan->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mt-4">
                  <label class="text-secondary mb-2">Nama Kendaraan</label>
                  <input type="text" class="form-control border border-secondary form-control" name="nama" required value="{{ $layanankendaraan->nama }}">
                ...
                <div class="form-group mt-1">
                  ...
                  <textarea  type="text" class="form-control border border-secondary form-control" name="isi" required>{{ old('isi', $layanankendaraan->isi) }}</textarea>
                  <span class="text-danger">
                    @error('isi')
                    {{ $message }}
                    @enderror
