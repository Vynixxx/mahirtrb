              ...
              <table class="table">
                ...
                <tr>
                  <th scope="row">{{ $loop->iteration }}</th>
                    ...
                    <td>{{ $e->jml }}</td>
                    <td>
                        @if(is_null($e->invoice_no) || is_null($e->harga_total))
                            <span class="text-muted">Diskusi belum dilakukan</span>
                        @else
                            {{ $e->invoice_no }} <br> Rp. {{ number_format($e->harga_total, 0, ',', '.') }}
                        @endif
                    </td> 
                    <td>
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              Apakah Anda yakin ingin menghapus pemesanan ekspedisi dari <b id="namaEkspedisi"></b>?
                          </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".btn-delete").forEach(button => {
            button.addEventListener("click", function () {
                let ekspedisiNama = this.getAttribute("data-nama");
                let deleteUrl = this.getAttribute("data-url");

                document.getElementById("namaEkspedisi").innerText = ekspedisiNama;
