                ...
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <div class="modal fade" id="invoiceModal" tabindex="-1" aria-labelledby="invoiceModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{ route('admin.kirimInvoicePerbaikan') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $perb->id }}">
                                    <input type="hidden" name="email" value="{{ $perb->email }}">
                                    <input type="hidden" name="nama" value="{{ $perb->nama }}">
